...
/*
function restartGame(){     //  سرعة الكورة في البداية  
ball.velocityX = 5
ball.velocityY = 5
}*/
...
let AILevel = 1.5                                                                         // ai levvel up or down 
...
ball.velocityX = direction * ball.speed * Math.cos(angleRad)                               //when the ai kik the ball the speed go up
